...
export default function AppHeader({page}:{page:'Build'|'Simulation'}){
 ...
 <nav id="notch-navigation" aria-label="Main navigation"><a href="https://worldforge-nine.vercel.app/">Home</a><a href="/" aria-current={page==='Build'?'page':undefined}>Build</a><span className="notch-spacer" aria-hidden="true"/><a href="/lab?scenario=crossdock" aria-current={page==='Simulation'?'page':undefined}>Simulation</a><a href="https://rithish.vercel.app/" target="_blank" rel="noreferrer">Contact ↗</a></nav></div>
