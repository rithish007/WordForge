...
export default function WarehouseLab(){
 ...
 return <main className={"lab-page"+(result?.metrics?" has-results":"")}>
 <header className="topbar"><a className="brand" href="/"><Brand/><span className="brand-divider">/</span><span className="brand-sub">Lab</span></a><div className="top-right"><span className="prototype-label">Local</span><ThemeSelect/></div></header>
 ...
 </details><div className="section-title space-top"><span>Robot</span></div>
 ...
 <div className="lab-heading"><div><h1>{world?.name??'Warehouse lab'}</h1></div><div className={'validation-pill '+(validation?.report.navigable?'good':'')}><span/>{validation?validation.report.navigable?'Navigable':'Check route':'Connecting…'}</div></div>
